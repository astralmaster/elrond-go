...
import (
	...
	nodeFactory "github.com/astralmaster/elrond-go/cmd/node/factory"
	...
	"github.com/astralmaster/elrond-go/consensus/spos/sposFactory"
	"github.com/astralmaster/elrond-go/dataRetriever"
	"github.com/astralmaster/elrond-go/dataRetriever/factory/containers"
	"github.com/astralmaster/elrond-go/dataRetriever/factory/resolverscontainer"
	"github.com/astralmaster/elrond-go/dataRetriever/requestHandlers"
	"github.com/astralmaster/elrond-go/dblookupext"
	"github.com/astralmaster/elrond-go/epochStart/metachain"
	"github.com/astralmaster/elrond-go/epochStart/notifier"
	"github.com/astralmaster/elrond-go/epochStart/shardchain"
	mainFactory "github.com/astralmaster/elrond-go/factory"
	hdrFactory "github.com/astralmaster/elrond-go/factory/block"
	"github.com/astralmaster/elrond-go/factory/peerSignatureHandler"
	"github.com/astralmaster/elrond-go/genesis"
	"github.com/astralmaster/elrond-go/genesis/process/disabled"
	...
	"github.com/astralmaster/elrond-go/node/nodeDebugFactory"
	"github.com/astralmaster/elrond-go/p2p"
	"github.com/astralmaster/elrond-go/process"
	"github.com/astralmaster/elrond-go/process/block"
	"github.com/astralmaster/elrond-go/process/block/bootstrapStorage"
	"github.com/astralmaster/elrond-go/process/block/postprocess"
	"github.com/astralmaster/elrond-go/process/block/preprocess"
	"github.com/astralmaster/elrond-go/process/coordinator"
	"github.com/astralmaster/elrond-go/process/economics"
	"github.com/astralmaster/elrond-go/process/factory"
	procFactory "github.com/astralmaster/elrond-go/process/factory"
	"github.com/astralmaster/elrond-go/process/factory/interceptorscontainer"
	metaProcess "github.com/astralmaster/elrond-go/process/factory/metachain"
	"github.com/astralmaster/elrond-go/process/factory/shard"
	"github.com/astralmaster/elrond-go/process/interceptors"
	processMock "github.com/astralmaster/elrond-go/process/mock"
	"github.com/astralmaster/elrond-go/process/peer"
	"github.com/astralmaster/elrond-go/process/rating"
	"github.com/astralmaster/elrond-go/process/rewardTransaction"
	"github.com/astralmaster/elrond-go/process/scToProtocol"
	"github.com/astralmaster/elrond-go/process/smartContract"
	"github.com/astralmaster/elrond-go/process/smartContract/builtInFunctions"
	"github.com/astralmaster/elrond-go/process/smartContract/hooks"
	processSync "github.com/astralmaster/elrond-go/process/sync"
	"github.com/astralmaster/elrond-go/process/track"
	"github.com/astralmaster/elrond-go/process/transaction"
	"github.com/astralmaster/elrond-go/process/transactionLog"
	...
	"github.com/astralmaster/elrond-go/storage/timecache"
	"github.com/astralmaster/elrond-go/storage/txcache"
	"github.com/astralmaster/elrond-go/testscommon"
	"github.com/astralmaster/elrond-go/testscommon/bootstrapMocks"
	...
	dblookupextMock "github.com/astralmaster/elrond-go/testscommon/dblookupext"
	"github.com/astralmaster/elrond-go/testscommon/economicsmocks"
	"github.com/astralmaster/elrond-go/testscommon/epochNotifier"
	"github.com/astralmaster/elrond-go/testscommon/mainFactoryMocks"
	...
	vmProcess "github.com/astralmaster/elrond-go/vm/process"
